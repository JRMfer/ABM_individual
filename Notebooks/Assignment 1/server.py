...
IPython.get_ipython().magic("run Mesa_introduction-4.ipynb")
...
# Create a dynamic linegraph for mean sheep eaten by wolves
chart2 = ChartModule([{"Label": "Mean", "Color": "red"}], 
                    data_collector_name="datacollector")
